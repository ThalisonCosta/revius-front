...
serve(async (req) => {
  ...
  try {
    ...
    const pricing = {
      pro: {
        amount: 899, // R$ 8,99 in centavos
        currency: 'brl',
        name: 'Pro Subscription'
      },
      premium: {
        amount: 1999, // R$ 19,99 in centavos
        currency: 'brl',
        name: 'Premium Subscription'
      }
    };

    const selectedPricing = pricing[tier as keyof typeof pricing] || pricing.pro;
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: { 
              ...
              description: `Access to premium features and ad-free experience`
            },
